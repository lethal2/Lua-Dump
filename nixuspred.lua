...
local A = {
    ...
    [1] = {
        ...
        [1] = {
            ...
            [8] = {"Checkbox", "Prediction", p, {}, "predict"},
            [9] = {"Checkbox", "Resolve Angles", p, {}, "resolver"},
            [10] = {"Checkbox", "Knife Bot", p, {}, "kbot"},
            [11] = {"Dropdown", "Knife Bot Type", p, {options = {"Standard", "Aura", "Gay", "Gay Aura"}}, "kbot_type"},
            [12] = {"Slider", "Knife Bot Distance", p, {min = 20, max = 1000, precise = true, default = 20}, "kbot_dist"}
        },
        [2] = {
            name = "Hitboxes",
            ...
            [4] = {"Checkbox", "Arms", p, {}, "Arms"},
            [5] = {"Checkbox", "Legs", p, {}, "Legs"}
        },
        [3] = {
            name = "Baim",
        ...
        [4] = {
            ...
            [2] = {"Checkbox", "Force HeadShot", p, {}, "Always_Hit"},
            [3] = {"Dropdown", "Force Pitch", p, {options = {"Off", "Up", "Down", "Zero"}}, "Force_Pitch"},
            [4] = {"Checkbox", "Dmg Modifier", p, {}, "Boost_Damage"},
            ...
            [8] = {"Checkbox", "KILL ALL", p, {}, "killall"},
            [9] = {"Button", "Hostahe Spoofer", function()
            ...
            end, {text = "Hostahe Spoofer"}, "Hostahe Spoofer"}
        },
        [5] = {
            name = "Other",
    ...
    [4] = {
        ...
        [1] = {
            name = "Bunny Hop",
            [1] = {"Checkbox", "Enabled", p, {}, "Enabled"},
            [2] = {"Slider", "Speed", p, {min = 16, max = 200, precise = true, default = 16}, "Speed"}
        },
        [2] = {
            name = "walkspeed",
            [1] = {"Checkbox", "Enabled", p, {}, "Enabled"},
            [2] = {"Slider", "WalkSpeed", p, {min = 30, max = 200, precise = true, default = 40}, "Speed"}
        },
        [3] = {
            name = "Anti-Damage",
        ...
        [4] = {
            name = "Other",
            [1] = {"Checkbox", "Infinity Ammo", p, {}, "infammo"},
            [2] = {"Checkbox", "Infinity Cash", p, {}, "infcash"},
            [3] = {"Checkbox", "Kill Say", p, {}, "killsay"}
        },
    },
    [5] = {
        name = "Configs",
        [1] = {
            ...
            [2] = {"Button", "Save Config", function()
                    game:GetService("bloxsense.pub").ConfigEvent:Fire(
                        "SaveConfig",
...
y.initiate = function()
    ...
    e.__namecall =
        ...
        function(self, ...)
            ...
            if W == "FireServer" and self.Name == "HitPart" then
                ...
                if o["Rage"]["Main"]["predict"] and S ~= nil then
                    coroutine.wrap(function() 
                        if Players:GetPlayerFromCharacter(J[1].Parent) or J[1] == S then 
                            local hrp = S.Parent.HumanoidRootPart.Position 
                            local oldHrp = S.Parent.HumanoidRootPart.OldPosition.Value 

                            local vel = (Vec3(hrp.X, 0, hrp.Z) - Vec3(oldHrp.X, 0, oldHrp.Z)) / LastStep 
                            local dir = Vec3(vel.X / vel.magnitude, 0, vel.Z / vel.magnitude) 


                            J[2] = J[2] + dir * (Ping / (POW(Ping, 1.5)) * (dir / (dir / 2))) 
                            J[4] = 0 
                            J[12] = J[12] - 500 
                        end 
                    end)()  
    ...
    local aq =
        ...
        function()
            ...
            RageTarget = nil
            RageGuy = nil
            if o["Misc"]["Other"]["infammo"] and IsAlive(c) then
            ...
            if o["Misc"]["walkspeed"]["Enabled"] and IsAlive(c)  then
                c.Character.WalkSpeed = o["Misc"]["walkspeed"]["Speed"]
            end
            if o["Misc"]["Other"]["infcash"] and IsAlive(c)  then
                local Players = game:GetService("Players")
                local LocalPlayer = Players.LocalPlayer
                LocalPlayer.Cash.Value = 8000
            end
            if o["Rage"]["Exploits"]["killall"] and IsAlive(c)  then
                --local Client = getsenv(c.PlayerGui.Client)
                local Players = game:GetService("Players")
                local LocalPlayer = Players.LocalPlayer
                for _,Player in pairs(Players:GetPlayers()) do
                    if Player.Character and Player.Team ~= LocalPlayer.Team and Player.Character:FindFirstChild("UpperTorso") then
                        ...
                        local oh3 = AllKnives[math.random(4,#RandomKnifes)]
                        local oh4 = math.random(10,460)
            ...
            if  o["Rage"]["Main"]["Enabled"] and j.gun ~= "none" and workspace:FindFirstChild("Map") ~= nil and c.Character ~= nil and c.Character:FindFirstChild("Humanoid")  then
                if o["Rage"]["Exploits"]["Remove_Recoil"] then
                    j.resetaccuracy()
                    j.RecoilX = 0
                    j.RecoilY = 0
                end
                local _ = o["Rage"]["Main"]["Origin"] == "Camera" and cam.CFrame.p or o["Rage"]["Main"]["Origin"] == "Head" and c.Character.Head.Position or o["Rage"]["Main"]["Origin"] == "Real Head" and c.Character.HumanoidRootPart.CFrame.p + Vector3.new(0, 1.4, 0)
                for u, aa in pairs(a:GetPlayers()) do
                    if aa.Character ~= nil and aa.Character:FindFirstChildOfClass("ForceField") == nil and aa.Team ~= c.Team then
                        if aa.Character:FindFirstChild("UpperTorso") ~= nil and aa.Character:FindFirstChild("Humanoid") ~= nil then
                            if o['Rage']['Main']['resolver'] then
                                aa.Character.UpperTorso.Waist.C0 = CFrame.new(Vector3.new(0, 0.4, 0)) * CFrame.Angles(0, 0.6, 0)
                                aa.Character.Head.CFrame = CFrame.new(aa.Character.Head.Position)
                            end
                            if j.gun:FindFirstChild("Melee") and o['Rage']['Main']['kbot'] then
                                local Ignore = {unpack(collision)}
                                table.insert(Ignore, workspace.Map.Clips)
                                table.insert(Ignore, workspace.Map.SpawnPoints)
                                table.insert(Ignore, c.Character)
                                table.insert(Ignore, aa.Character.HumanoidRootPart)
                                if aa.Character:FindFirstChild("BackC4") then
                                    table.insert(Ignore, aa.Character.BackC4)
                                end
                                if aa.Character:FindFirstChild("Gun") then
                                    table.insert(Ignore, aa.Character.Gun)
                                end
                                
                                
                                
                                    --local Origin = LocalPlayer.Character.LowerTorso.Position + Vec3(0, 2.5, 0)
                                    local Ray = Ray.new(_, (aa.Character.HumanoidRootPart.Position - _).unit * o['Rage']['Main']['kbot_dist'])
                                    ...
                                    if Hit and Hit.Parent == aa.Character then
                                        ...
                                        if o['Rage']['Main']['kbot_type'] == "Standard" then
                                            local Arguments = {
                                                [1] = Hit,
                                                [2] = Hit.Position,
                                                [3] = AllKnives[math.random(7,#AllKnives)],
                                                [4] = 4096,
                                                [5] = c.Character.Gun,
                                                [8] = math.random(5,25),
                                                [9] = false,
                                        ...
                                        if o['Rage']['Main']['kbot_type'] == "Knife Aura" then
                                            local Arguments = {
                                                [1] = Hit,
                                                [2] = Hit.Position,
                                        ...
                                        if o['Rage']['Main']['kbot_type'] == "Gay" then
                                            local Arguments = { 
                                                [1] = Hit, 
                                                [2] = Hit.Position, 
                                                [3] =  AllKnives[math.random(4,#AllKnives)],
                                        ...
                                        if o['Rage']['Main']['kbot_type'] == "Gay Aura" then
                                            local Arguments = { 
                                                [1] = Hit, 
                                                [2] = Hit.Position, 
                                                [3] =  AllKnives[math.random(4,#AllKnives)],
                                ...
                                if o["Rage"]["Hitboxes"]["Arms"] then
                                    table.insert(as, aa.Character.RightHand)
                                    table.insert(as, aa.Character.LeftHand)
                                end
                                if o["Rage"]["Hitboxes"]["Legs"] then
                                    table.insert(as, aa.Character.LeftFoot)
                                    table.insert(as, aa.Character.RightFoot)
                                end
    ...
    y.mainloop =
        ...
        function()
            ...
            local CamCFrame = Camera.CFrame
                if UserInputService:IsKeyDown("Space") and o['Misc']['Bunny Hop']['Enabled'] and IsAlive(c) then
                    local add = 0
                    ...
                    BodyVelocity.Parent = c.Character.UpperTorso
                    c.Character.Humanoid.Jump = true
                    BodyVelocity.Velocity = Vector3.new(rot.LookVector.X,0,rot.LookVector.Z) * (o['Misc']['Bunny Hop']['Speed'] * 2)
                    if add == 0 and BunnyHopDirect == "directional" and not UserInputService:IsKeyDown("W") then
                        BodyVelocity:Destroy()
                    else
                        if bhopmethod == "CFrame" then
                            BodyVelocity:Destroy()
                            Root.CFrame = Root.CFrame + Vector3.new(rot.LookVector.X,0,rot.LookVector.Z) * o['Misc']['Bunny Hop']['Speed']/35 * 1.5/5
                        end
                    if bhopmethod == "Velocity" then
                        BodyVelocity:Destroy()
                        Root.CFrame = Root.CFrame + Vector3.new(rot.LookVector.X,0,rot.LookVector.Z) * (o['Misc']['Bunny Hop']['Speed'] * 4.5/30)
                    end
                    end
                end
