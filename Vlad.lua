...
if not isfolder("Vladity") then
	print("creating Vladity folder")
	makefolder("Vladity")
end

if not isfolder("Vladity/configs") then
	print("creating Vladity configs folder")
	makefolder("heVladityxagon/configs")
end

if not isfile("Vladity/autoload.txt") then
	print("creating Vladity autoload file")
	writefile("Vladity/autoload.txt", "")
end

if not isfile("Vladity/custom_skins.txt") then
	print("downloading Vladity custom skins file")
	writefile("Vladity/custom_skins.txt", game:HttpGet("https://raw.githubusercontent.com/Pawel12d/hexagon/main/scripts/default_data/custom_skins.txt"))
end

if not isfile("Vladity/custom_models.txt") then
	print("downloading Vladity custom models file")
	writefile("Vladity/custom_models.txt", game:HttpGet("https://raw.githubusercontent.com/Pawel12d/hexagon/main/scripts/default_data/custom_models.txt"))
end

if not isfile("Vladity/inventories.txt") then
	print("downloading Vladity inventories file")
	writefile("Vladity/inventories.txt", game:HttpGet("https://raw.githubusercontent.com/Pawel12d/hexagon/main/scripts/default_data/inventories.txt"))
end

if not isfile("Vladity/skyboxes.txt") then
	print("downloading Vladity skyboxes file")
	writefile("Vladity/skyboxes.txt", game:HttpGet("https://raw.githubusercontent.com/Pawel12d/hexagon/main/scripts/default_data/skyboxes.txt"))
end
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	...
	if values.misc.chat["kill say"].Toggle then      
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "Get Vladity.cc Today $$$🤔🤪🤪🤪🤔🤪😛🤪😍🤪😂😘🤩😘🙂🙂🤔🙂😛😘🤩😘🤩😝🤫😝🤫😝😛😝🤩😝🤩😝🤩😝🤩😝😍😝😛😝😛😝🤪😛🤪😍🤪😂😘🤩$$$ Get Vladity.cc Today!", false, "Innocent", false, true)  
	end      
end)      
