...
-- i'm too lazy to write that shit in chat spam and that wont work prob.
while values.misc.chat["chat spam"].Toggle and values.misc.chat.type.Dropdown == 'emojies' do
	for i = 1, #emojiespam do
	wait(values.misc.chat["speed (ms)"].Slider/1000) 
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(emojiespam[i], false, "Innocent", false, true)
	end
end
