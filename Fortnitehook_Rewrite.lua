...
library:CreateWatermark("Fortnite | Hook | Rewrite ")
...
local cfglocation = "FNHOOK-REWRITE-CFGS/" 
makefolder("FNHOOK-REWRITE-CFGS") 
...
local gui = library:New("Fortnitehook Rewrite") 
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("Fnhook Rewrite\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
