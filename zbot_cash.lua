...
print("Loading...")
wait(2.0)
print("loaded. welcome to  zbot.cash")
...
function library:New(name)
	...
	Menu.Image = "http://www.roblox.com/asset/?id=7856811676"
...
luascripts:Element("Button", "load", {}, function()
	loadstring(readfile("zbot_cash/cfg/cbro/lua\\"..values.luas["lua scripts"].lua.Scroll))()
end)
...
local antiaim = aa:Sector("angles", "Left")      
...
local others = aa:Sector("others", "Right")
...
movement:Element("Slider", "speed", {min = 0, max = 150, default = 40})
